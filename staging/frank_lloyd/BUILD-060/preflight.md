# Frank Lloyd — BUILD-060 Pre-flight Checklist

**Build ID**: BUILD-060  
**Title**: Create API endpoint returns current portfolio  
**Generated**: 2026-04-11T23:45:14.669787+00:00  
...
**Answer**: The test coverage plan includes 'frank_lloyd/job.py' for portfolio data and 'tests/test_portfolio_snapshot.py' for testing.
